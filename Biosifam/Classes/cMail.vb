...
Public Class cMail
    ...
    Function Enviar() As Boolean
        ...
        _sl.Ocorrencias(0, "Envio de Email", "cMail", "Enviar", "Iniciando Email, assunto: " & vsAssunto, False, True)
        ...
        If vsErro <> "" Then
            ...
            _sl.Ocorrencias(1, "Envio de Email", "cMail", "Enviar", "Erro na preparação do email, " & vsErro, True, True) : Exit Function
        End If
        ...
        Try
            ...
            _sl.Ocorrencias(0, "Envio de Email", "cMail", "Enviar", "concluído com sucesso, " & vsAssunto, vbMostrarMensagem, True, True)
            Enviar = True
        Catch ex As Exception
            _sl.Ocorrencias(1, "Envio de Email", "cMail", "Enviar", "Erro, " & ex.Message, vbMostrarMensagem, True, True)
        End Try
